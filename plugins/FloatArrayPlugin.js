/* Smalltalk from Squeak4.5 with VMMaker 4.13.6 translated as C source on 6 October 2014 12:13:47 am */
...
function primitiveAddFloatArray() {
	...
	length = SLOTSIZEOF(arg);
	interpreterProxy.success(length === (SLOTSIZEOF(rcvr)));
	if (interpreterProxy.failed()) {
		return null;
	}
...
function primitiveAt() {
	...
	interpreterProxy.success(interpreterProxy.isWords(rcvr));
	interpreterProxy.success((index > 0) && (index <= (SLOTSIZEOF(rcvr))));
	if (interpreterProxy.failed()) {
		return null;
	}
