/* Smalltalk from Squeak4.5 with VMMaker 4.13.6 translated as C source on 4 October 2014 3:42:02 pm */
/* Automatically generated by
	JSPluginCodeGenerator VMMakerJS-bf.2 uuid: 354e3141-358c-44ff-b3cf-a47b08b40e20
   from
...
var moduleName = "MiscPrimitivePlugin 4 October 2014 (e)";
...
function primitiveCompareString() {
	...
	len1 = string1.length;
	len2 = string2.length;
	for (i = 1, iLimiT = (Math.min(len1, len2)); i <= iLimiT; i++) {
...
function primitiveFindSubstring() {
	...
	for (startIndex = start, startIndexLimiT = (((body.length) - (key.length)) + 1); startIndex <= startIndexLimiT; startIndex++) {
		index = 1;
